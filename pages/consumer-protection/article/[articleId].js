...
export async function getStaticPaths() {
    ...
    const response = await fetch('https://turnitgreen-03e15fdc97d7.herokuapp.com/get-article-ids/Consumer%20Protection');
...
function ConsumerProtectionArticle({ articleData }) {
...
export default ConsumerProtectionArticle;
