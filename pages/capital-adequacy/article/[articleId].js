...
export async function getStaticPaths() {
    ...
    const response = await fetch('https://turnitgreen-03e15fdc97d7.herokuapp.com/get-article-ids/Capital%20Adequacy');
...
function CapitalAdequacyArticle({ articleData }) {
...
export default CapitalAdequacyArticle;
